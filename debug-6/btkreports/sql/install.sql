...
CREATE TABLE IF NOT EXISTS `mod_btk_abone_hareket_live` (
    `id` BIGINT AUTO_INCREMENT PRIMARY KEY,
    `rehber_kayit_id` BIGINT NOT NULL COMMENT 'mod_btk_abone_rehber.id',
...
ALTER TABLE `mod_btk_abone_hareket_archive` DROP PRIMARY KEY, ADD PRIMARY KEY (`id`), MODIFY `id` BIGINT NOT NULL; 
