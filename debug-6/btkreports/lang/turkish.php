...
$_ADDONLANG['dateFormatYYYYMMDDTooltip'] = "Format: YYYYAAGG (Örn: 19801231)";
...
$_ADDONLANG['serviceCannotDeleteBtkReason'] = "BTK Modülü: Bu hizmet aktif, askıya alınmış veya sonlandırılmış olduğu için silinemez. Kayıtlar BTK için korunmalıdır.";
$_ADDONLANG['logsDeletedSuccess'] = "Tüm günlük kayıtları başarıyla silindi.";
$_ADDONLANG['logsDeletedError'] = "Günlük kayıtları silinirken bir hata oluştu.";
$_ADDONLANG['reportGeneratedSuccess'] = "Rapor başarıyla oluşturuldu.";
$_ADDONLANG['reportGenerationFailed'] = "Rapor oluşturulurken hata oluştu.";
$_ADDONLANG['fileNotFound'] = "Dosya bulunamadı veya süresi dolmuş.";
$_ADDONLANG['noDataForReport'] = "%s raporu için veri bulunamadı. Boş rapor gönderimi kapalı.";
$_ADDONLANG['btkFieldMappingMissing'] = "%s raporu için BTK alan sıralaması eksik.";
$_ADDONLANG['reportCompressionFailed'] = "%s raporu sıkıştırılırken hata oluştu.";
$_ADDONLANG['unknownReportType'] = "Bilinmeyen rapor türü.";
...
$_ADDONLANG['musteriTipiG-SAHIS'] = "Bireysel Şahıs";
$_ADDONLANG['musteriTipiT-SIRKET'] = "Tüzel Şirket";
