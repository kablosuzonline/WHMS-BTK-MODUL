...
$hook = array(
    ...
    'function' => 'AfterRegistrarRegistrationWa',
    'description' => 'Executes after a successful domain register command.<br>Client Related<br>First Name: {firstname}, Last Name: {lastname}<br>Service Related<br>Domain: {domain}',
    'type' => 'client',
    'extra' => '',
...
if(!function_exists('AfterRegistrarRegistrationWa')){
    function AfterRegistrarRegistrationWa($args){
        $api = new wamessenger();
