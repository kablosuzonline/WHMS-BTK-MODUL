...
$hook = array(
    ...
    'function' => 'AfterRegistrarRegistrationFailed_adminWa',
...
if(!function_exists('AfterRegistrarRegistrationFailed_adminWa')){
    function AfterRegistrarRegistrationFailed_adminWA($args){
        $api = new wamessenger();
