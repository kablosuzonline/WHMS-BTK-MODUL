...
$hook = array(
    'hook' => 'DailyCronJob',
    'function' => 'DomainRenewalNoticeWa',
    'description' => 'Domain Renewal Notice before {x} days.<br>Client Related<br>First Name: {firstname}, Last Name: {lastname}, Currency: {currency}<br>Service Related<br>Domain: {domain}, Registration Date: {registrationdate}, First Payment Amount: {firstpaymentamount}, Recurring Amount: {recurringamount}, Registrar: {registrar}, Next Duedate: {nextduedate}, Next Invoice Date: {nextinvoicedate}, Payment Method: {paymentmethod}, Expiry Date: {expirydate}, Number of Days: {x}',
    'type' => 'client',
    'extra' => '15',
    ...
    'variables' => '{firstname}, {lastname}, {domain},{registrationdate},{firstpaymentamount},{recurringamount},{registrar},{nextduedate},{nextinvoicedate},{paymentmethod},{expirydate},{x},{currency}'
);
if(!function_exists('DomainRenewalNoticeWa')){
    function DomainRenewalNoticeWa($args){
