...
kerio.waw.ui.trafficHostEditor = {
...
k_isEditMode = 'trafficHostEdit' === k_objectName,
k_form, k_formCfg,
...
? k_tr('Edit Host, Network, Address Range, IP Prefix', 'trafficHostEditor')
: k_tr('Add Host, Network, Address Range, IP Prefix', 'trafficHostEditor'),
...
? k_params.k_data.item                        : kerio.waw.shared.k_DEFINITIONS.k_get('k_trafficEntity'),   k_trafficRuleGrid = k_params.k_parentGrid.k_getMainWidget().k_parentGrid,
k_form = this.k_form;
...
k_grid.k_addItem(k_data, k_hostTypes.TrafficEntityAddressGroup);
this.k_hide();
},
