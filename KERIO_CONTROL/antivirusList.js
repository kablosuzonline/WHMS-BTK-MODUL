...
k_tabs.push({
k_id: 'k_engineTab',
k_caption: k_tr('Kerio Antivirus', 'antivirusList'),
...
k_antivirusGetJson = { method: 'Antivirus.get' };
k_tabPage.k_addReferences({
k_loadRequest: [
{
k_jsonRpc: k_antivirusGetJson,
...
k_antivirusGetJson: k_antivirusGetJson,
k_updateAvStatus: function() {
kerio.lib.k_ajax.k_request({
k_jsonRpc: this.k_antivirusGetJson,
k_callback: function(k_response, k_success) {
var
k_config;
if (k_success && k_response.k_isOk) {
k_config = k_response.k_decoded.config;
this.k_setAvData(k_config.antivirus, true);
}
},
k_scope: this
});
...
k_changeUiForUnregisteredTrial: function() {
var
k_methods = kerio.waw.shared.k_methods,
k_isUnregisteredTrial = k_methods.k_isTrial(false);
this.k_engineForm.k_setVisible(['k_integratedEngineUpdateContainer'], !k_isUnregisteredTrial);
this.k_engineForm.k_setDisabled(k_isUnregisteredTrial);
this.k_emailScanningForm.k_setDisabled(k_isUnregisteredTrial);
this.k_scanRulesGrid.k_setDisabled(k_isUnregisteredTrial);
this.k_httpFtpScanningForm.k_setDisabled(k_isUnregisteredTrial);
if (k_isUnregisteredTrial) {
this.k_engineForm.k_getItem('k_infoUnregisteredTrial').k_forceSetEnabled();
}
else {
this.k_engineForm.k_getItem('k_infoUnregisteredTrial').k_setVisible(false);
this.k_hideInfoUnregisteredTrial = k_methods.k_emptyFunction;
}
},
...
this.k_changeUiForUnregisteredTrial();
},
...
k_option: k_tr('Use Kerio Antivirus', 'antivirusList'),
...
k_antivirusSoftware = {
k_type: 'k_fieldset',
k_caption: k_tr('Antivirus', 'antivirusList'),
k_isLabelHidden: true,
k_items: [
k_useIntegratedAntivirusCheckbox,
{
...
{
k_type: 'k_display',
k_id: 'k_infoUnregisteredTrial',
k_icon: 'img/warning.png?v=8629',
k_className: 'warningImgIcon',
k_isHidden: !k_shared.k_methods.k_isTrial(false),
k_template: '{k_message} <a id="k_gotoRegister">{k_link}</a>',
k_value: {
k_message: k_tr('Kerio Antivirus is not available in the unregistered trial.', 'antivirusList'),
k_link: k_tr('Please register to enable Kerio Antivirus.', 'antivirusList')
},
...
k_caption: k_tr('Updates', 'antivirusList'),
k_className: 'integratedEngineUpdate',
k_minHeight: 125,
k_items: [
{
k_type: 'k_columns',
...
k_caption: k_tr('Threat definitions count:', 'antivirusList')
}
]
},
{
...
if (AntivirusUpdatePhases.AntivirusUpdateOk === k_status.phase || AntivirusUpdatePhases.AntivirusUpdateFailed === k_status.phase) {
this.k_updateAvStatus();
}
...
k_internalAntivirusFieldsetHeight = 120;
...
k_avStatus = k_tr('You don\'t have a valid license for Kerio Antivirus.', 'antivirusList');
k_link = k_tr('To enable Kerio Antivirus, register a new license number that includes Kerio Antivirus.', 'antivirusList');
k_avIcon = 'warning';
}
...
k_link = k_tr('To enable Kerio Antivirus updates, register a new Software Maintenance number that includes Kerio Antivirus.', 'antivirusList');
k_avIcon = 'warning';
}
}
...
this.k_getItem('k_integratedEngineUpdateContainer').k_setSize({k_height: k_internalAntivirusFieldsetHeight});
...
k_avStatus = k_tr('The antivirus is running.', 'antivirusList');
}
...
k_avStatus = k_tr('The antivirus has failed to start!', 'antivirusList');
k_avIcon = 'error';
break;
...
k_avStatus = k_tr('Waiting for download of initial threat definitions database.', 'antivirusList');
k_avIcon = 'warning';
break;
}
