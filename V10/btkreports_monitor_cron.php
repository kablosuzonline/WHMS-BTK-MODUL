 ...
 * İzlenmesi aktif edilen POP noktalarının canlı durumunu (ping) kontrol eder.
...
try {
    ...
    foreach ($popsToMonitor as $popArray) {
        try {
            ...
            Capsule::table('mod_btk_iss_pop_noktalari')->where('id', $popArray['id'])->update([
            ...
            BtkHelper::logAction('Tekil POP İzleme Hatası', 'HATA', "POP ID: {$popArray['id']} izlenirken hata: " . $singlePopError->getMessage());
        }
    }
