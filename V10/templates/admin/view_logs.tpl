...
<div class="tab-content" style="margin-top: 20px;">
    <div role="tabpanel" class="tab-pane active" id="moduleLogs">
                ...
                <table class="table table-striped table-bordered" width="100%">
                    ...
                    <tbody>
                        {foreach from=$logs.general.data item=log}
                            <tr>
                                <td>{$log.log_zamani|date_format:$smarty.const.MYSQL_DATETIME_FORMAT}</td>
                                <td>
        ...
        {else}
            <div class="alert alert-info text-center">{$LANG.noGeneralLogsFound}</div>
        {/if}
    </div>
    <div role="tabpanel" class="tab-pane" id="ftpLogs">
        {if $logs.ftp.data}
                ...
                <table class="table table-striped table-bordered" width="100%">
                    ...
                    <tbody>
                        {foreach from=$logs.ftp.data item=log}
                            <tr>
                                <td>{$log.gonderim_zamani|date_format:$smarty.const.MYSQL_DATETIME_FORMAT}</td>
                                ...
                                <td>
                                    ...
                                    {else}
                                        <span class="label label-danger" title="{$log.hata_mesaji|escape}">Hatalı</span>
                                    {/if}
                                </td>
            ...
            {$logs.ftp.pagination}
        {else}
            <div class="alert alert-info text-center">{$LANG.noFtpLogsFound}</div>
        {/if}
    </div>
</div>
