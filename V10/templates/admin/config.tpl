...
<div class="panel panel-default btk-widget">
    ...
    <div class="panel-body">
        <p class="help-block">{$LANG.btkYetkilendirmeDesc}</p>
        {* Yeni CSS kuralı bu div'e etki edecek ve üst boşluğu sağlayacak *}
        <div class="row btk-yetki-list">
            {foreach from=$yetki_turleri item=yt}
                <div class="col-md-6">
                    {* CSS'teki .form-group kuralı burayı hizalayacak *}
                    <div class="form-group">
                        <div class="btk-switch">
                            <input type="checkbox" name="yetkiler[{$yt.yetki_kodu|escape:'html'}]" id="yetki_toggle_{$yt.yetki_kodu|escape:'url'}" value="1" {if $yt.aktif == 1}checked{/if}>
                            <label for="yetki_toggle_{$yt.yetki_kodu|escape:'url'}" class="btk-slider round"></label>
                        </div>
                        <label for="yetki_toggle_{$yt.yetki_kodu|escape:'url'}">
                            {$yt.yetki_adi|escape:'html'} <strong>({$yt.grup|escape:'html'})</strong>
                        </label>
                        <i class="fas fa-info-circle btk-tooltip" title="Açıklama buraya gelecek..."></i>
                    </div>
                </div>
            {/foreach}
        </div>
