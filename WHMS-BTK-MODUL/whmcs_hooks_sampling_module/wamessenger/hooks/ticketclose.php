...
$hook = array(
    'hook' => 'TicketClose',
    'function' => 'TicketCloseWa',
    'description' => 'Executes when a ticket is closed.<br>Client Related<br>First Name: {firstname}, Last Name: {lastname}, Email Address: {email}, Company Name: {companyname}, Credit Balance: {credit}, Country: {country}, Currency: {currency}<br>Support Ticket Related<br>Ticket Number: {tid}, Date Created: {date}, Subject: {title}, ID: {ticketid}, Message: {message}, Status: {status}, Priority: {urgency}, Department: {department}, Last Reply Message: {last_reply_message}, Last Reply Date: {last_reply_date}',
    'type' => 'client',
    'extra' => '',
...
if(!function_exists('TicketCloseWa')){
    function TicketCloseWa($args){
        $api = new wamessenger();
