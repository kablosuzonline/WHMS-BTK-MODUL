// --- BÖLÜM 1 / 1 BAŞI - (service_details_btk_form.tpl, Hizmet Detayları BTK Bilgi Formu)
{*
...
// --- BÖLÜM 1 / 1 SONU - (service_details_btk_form.tpl, Hizmet Detayları BTK Bilgi Formu)