// --- BÖLÜM 1 / 1 BAŞI - (generate_reports.tpl, Manuel Rapor Oluşturma ve Gönderme Sayfası)
{*
...
// --- BÖLÜM 1 / 1 SONU - (generate_reports.tpl, Manuel Rapor Oluşturma ve Gönderme Sayfası)