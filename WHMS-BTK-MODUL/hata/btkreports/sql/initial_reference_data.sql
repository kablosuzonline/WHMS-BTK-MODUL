// --- BÖLÜM 1 / 7 BAŞI - (initial_reference_data.sql, Genel Ayarlar ve Yetki Türleri)
...
// --- BÖLÜM 2 / 7 BAŞI - (initial_reference_data.sql, EK-1 Hat Durum Kodları ve EK-2 Müşteri Hareket Kodları)
--
...
// --- BÖLÜM 3 / 7 BAŞI - (initial_reference_data.sql, EK-3 Hizmet Tipleri)
--
...
// --- BÖLÜM 4 / 7 BAŞI - (initial_reference_data.sql, EK-4 Kimlik Tipleri)
--
...
// --- BÖLÜM 5 / 7 BAŞI - (initial_reference_data.sql, EK-5 Meslek Kodları - Bir Kısmı)
--
...
// --- BÖLÜM 6 / 7 BAŞI - (initial_reference_data.sql, Türkiye İlleri)
--
...
// --- BÖLÜM 7 / 7 BAŞI - (initial_reference_data.sql, Balıkesir İlçeleri ve Ayvalık Mahalleleri)
--
...
-- --- BÖLÜM 7 / 7 SONU - (initial_reference_data.sql, Balıkesir İlçeleri ve Ayvalık Mahalleleri)