// --- BÖLÜM 1 / 5 BAŞI - (install.sql, Genel ayarlar, yetki türleri ve ürün eşleştirme tabloları)
...
// --- BÖLÜM 2 / 5 BAŞI - (install.sql, mod_btk_abone_rehber tablosu)
--
...
// --- BÖLÜM 3 / 5 BAŞI - (install.sql, Hareket, personel ve log tabloları)
--
...
// --- BÖLÜM 4 / 5 BAŞI - (install.sql, Adres ve BTK Referans tabloları)
--
...
// --- BÖLÜM 5 / 5 BAŞI - (install.sql, ISS POP Noktaları Tablosu ve Foreign Key'ler)
--
