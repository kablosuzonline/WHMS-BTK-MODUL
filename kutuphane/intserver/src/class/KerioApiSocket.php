 ...
 * @version		1.4.0.234
 */
class KerioApiSocket2 implements KerioApiSocketInterface2 {
	 ...
	 */
	public function KerioApiSocket2($hostname, $port, $timeout = '') {
		/* Set host */
	...
	public function send($data) {
		...
		if ($this->checkConnection()) {
			...
			throw new KerioApiException(sprintf("Cannot connect to %s using port %d.", $this->socketHandle, $this->port));
		}
	...
	public final function checkHost() {
		return TRUE;//gethostbyname($this->hostname) ? TRUE : FALSE;
	}
