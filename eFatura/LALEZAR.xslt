			...
			<body style="margin-left=0.6in; margin-right=0.6in;  margin-bottom=0.79in;border-top: 2px solid #00AF33;height:auto; width:793px; margin-top:10px">
				<xsl:for-each select="$XML">
					...
					<table id="lineTable" width="793" style="border:0px; border-color: gray;">
						<tbody>
							<tr id="lineTableTr">
								<td id="lineTableTd" style="background-color: #00AF33; color: white;" align="center">
									<span style="font-weight:bold; ">
										<xsl:text>No</xsl:text>
									</span>
								</td>
								<!--<td id="lineTableTd" style="width:144px; background-color: #00AF33; color: white;border-right-width:0px;" align="center">
									<span style="font-weight:bold; ">
										<xsl:text>Kodu</xsl:text>
									</span>
								</td>-->
								<td id="lineTableTd" style="width:294px; background-color: #00AF33; color: white;" align="center">
									<span style="font-weight:bold; ">
										<xsl:text>Mal Hizmet</xsl:text>
									</span>
								</td>
								<!--<td id="lineTableTd" style="width:114px; background-color: #00AF33; color: white;border-right-width:0px;" align="center">
									<span style="font-weight:bold; ">
								...
								<td id="lineTableTd" style="width:74px; background-color: #00AF33; color: white;" align="center">
									<span style="font-weight:bold; ">
								...
								<td id="lineTableTd" style="width:100px; background-color: #00AF33; color: white;" align="center">
									<span style="font-weight:bold; ">
										<xsl:text>KDV Oranı</xsl:text>
									</span>
								</td>
								<td id="lineTableTd" style="width:84px; background-color: #00AF33; color: white;" align="center">
									<span style="font-weight:bold; ">
