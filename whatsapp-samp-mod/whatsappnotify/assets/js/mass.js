$(document).ready(function () {
    ...
    $('#sprodstatus').prop('disabled','disabled');
    $('.checkclientall').on('change', function () {
        if ($(this).val() === 'all') {
            $('.selectize-control').hide();
        } else {
    ...
    $('.countryvv').on('change', function () {
        if ($(this).val() === 'all') {
            $('#country').hide();
            $('#country').prop('disabled','disabled');
        } else {
            $('#country').show();
            $('#country').removeProp('disabled');
        }
    });
    $('.statusvv').on('change', function () {
        if ($(this).val() === 'all') {
            $('#sprodstatus').hide();
            $('#sprodstatus').prop('disabled','disabled');
        } else {
            $('#sprodstatus').show();
            $('#sprodstatus').removeProp('disabled');
        }
    });    
});
