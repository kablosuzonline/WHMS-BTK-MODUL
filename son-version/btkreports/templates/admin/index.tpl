            ...
            <div class="panel panel-default btk-widget">
                ...
                <div class="panel-body">
                    <div class="row text-center">
                        <div class="col-md-3"><div class="stat-box"><span class="stat-num">{$monitoring_stats.total}</span><span class="stat-label">{$LANG.totalMonitored}</span></div></div>
                        <div class="col-md-3"><div class="stat-box-success"><span class="stat-num">{$monitoring_stats.online}</span><span class="stat-label">{$LANG.popOnline}</span></div></div>
                        <div class="col-md-3"><div class="stat-box-danger"><span class="stat-num">{$monitoring_stats.offline}</span><span class="stat-label">{$LANG.popOffline}</span></div></div>
                        <div class="col-md-3"><div class="stat-box-warning"><span class="stat-num">{$monitoring_stats.high_latency}</span><span class="stat-label">{$LANG.popHighLatency}</span></div></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="panel panel-default btk-widget">
                ...
                <div class="panel-body">
                    ...
                    <ul class="list-inline">
                        ...
                        {if isset($next_cron_runs.monitor)}
