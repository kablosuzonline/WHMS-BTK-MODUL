 ...
 * Sürüm: 8.0.3 (Zirve) - Modern, nesne yönelimli ve fabrikasyon tabanlı yapı.
 *
 * @package    WHMCS
...
BtkHelper::logAction('BTK Raporlama Cron v8.0.3 Başladı', 'INFO');
echo "BTK Reporting Cron v8.0.3 has started...\n";
...
BtkHelper::logAction('BTK Raporlama Cron v8.0.3 Tamamlandı', 'INFO');
echo "BTK Reporting Cron v8.0.3 has completed.\n";
