{*
    ...
    Sürüm: 8.1.0 (Modern Arayüz)
*}

{* Harici bootstrap-toggle kütüphanesini çağıran bölüm. *}
...
<form method="post" action="{$modulelink}&action=save_config" id="btkConfigForm" class="form-horizontal">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5" style="padding-top:7px;">
                    <label class="control-label" style="margin-right:10px;">{$LANG.ftpSSL}</label>
                    <input type="checkbox" name="main_ftp_ssl" id="main_ftp_ssl" value="1" {if $settings.main_ftp_ssl == '1'}checked{/if} data-toggle="toggle" data-on="{$LANG.yes}" data-off="{$LANG.no}" data-onstyle="success" data-offstyle="danger" data-size="mini">
                </div>
            </div>
    ...
    <div class="panel panel-default btk-widget">
        <div class="panel-heading">
            <h3 class="panel-title">
                <input type="checkbox" name="backup_ftp_enabled" id="backup_ftp_enabled" value="1" {if $settings.backup_ftp_enabled == '1'}checked{/if} data-toggle="toggle" data-on="{$LANG.active}" data-off="{$LANG.passive}" data-onstyle="success" data-offstyle="default">
                <label for="backup_ftp_enabled" style="font-weight:600; cursor:pointer; margin-left:10px; vertical-align: middle;"><i class="fas fa-archive"></i> {$LANG.backupFtpSettingsTitle}</label>
            </h3>
        </div>
        <div class="panel-body" id="backup_ftp_details" {if !$settings.backup_ftp_enabled}style="display:none;"{/if}>
            ...
            <div class="form-group"><label for="backup_ftp_port" class="col-sm-3 control-label">{$LANG.ftpPort}</label><div class="col-sm-3"><input type="number" name="backup_ftp_port" id="backup_ftp_port" value="{$settings.backup_ftp_port|default:21}" class="form-control"></div><div class="col-sm-5" style="padding-top:7px;"><label class="control-label" style="margin-right:10px;">{$LANG.ftpSSL}</label><input type="checkbox" name="backup_ftp_ssl" id="backup_ftp_ssl" value="1" {if $settings.backup_ftp_ssl == '1'}checked{/if} data-toggle="toggle" data-on="{$LANG.yes}" data-off="{$LANG.no}" data-onstyle="success" data-offstyle="danger" data-size="mini"></div></div>
    ...
    <div class="panel panel-default btk-widget">
        <div class="panel-heading">
             <h3 class="panel-title">
                <input type="checkbox" name="pop_monitoring_enabled" id="pop_monitoring_enabled" value="1" {if $settings.pop_monitoring_enabled == '1'}checked{/if} data-toggle="toggle" data-on="{$LANG.active}" data-off="{$LANG.passive}">
                <label for="pop_monitoring_enabled" style="font-weight:600; cursor:pointer; margin-left:10px; vertical-align: middle;"><i class="fas fa-satellite-dish"></i> {$LANG.popMonitoringSettingsTitle}</label>
            </h3>
        </div>
        <div class="panel-body">
